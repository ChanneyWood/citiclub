package com.example.a12579.citiclub.my.cardverification.view;
...
public class AddSpaceTextWatcher implements TextWatcher {
    ...
    public void setImageView(int imageId) {
        mImageView = (ImageView) activity.findViewById(imageId);
    }
    ...
    public void afterTextChanged(Editable s) {
        String binkCode = editText.getText().toString();
        boolean isEmpty = binkCode.length() > 0;
        if (mImageView != null) {
            if (!isEmpty) {
